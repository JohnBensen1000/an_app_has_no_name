...
class TestNewUser(TestCase):
    ...
    def test_unique_fields_taken(self):
        ...
        self.assertEqual(body1, ["userID", "email", "uid"])
...
class TestPreferences(TestCase):
    ...
    def test_get_preference_fields(self):
        ...
        self.assertEqual(responseBody['fields'], Preferences().fields)
...
class TestUserPreferences(TestCase):
    def setUp(self):
        ...
        self.client = Client()
        self.url    = reverse('user_preferences', kwargs={'uid': self.uid})
    ...
    def test_post_user_preferences(self):
        newPreferences = ['art', 'fitness', 'food', 'comedy']
        ...
        self.assertEqual(updatedUser.preferences.travel, .1)
